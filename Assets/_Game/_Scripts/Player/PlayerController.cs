...
{
    public GameObject virtualCameraObject; // The GameObject with the Cinemachine Virtual Camera
    public GameObject target; // The GameObject you want the camera to follow
    ...
    private void SpeedControl()
    {
        ...
        else if (flatVel.magnitude > moveSpeed && InWind)
        {
            ...
            {
                _animator.SetFloat(_animIDSpeed, _animationBlend);
                _animator.SetFloat(_animIDMotionSpeed, flatVel.magnitude);
            }
        }
